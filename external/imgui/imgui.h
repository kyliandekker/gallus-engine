...
#define IM_ASSERT(_EXPR)\
    ((_EXPR) ? (void)0 : __debugbreak())                               // You can override the default assert handler by editing imconfig.h
#endif
...
namespace ImGui
{
	...
	IMGUI_API bool          TreeNodeExS(const char* label, ImVec2 size, ImGuiTreeNodeFlags flags = 0);
...
//   Use AddNgon() and AddNgonFilled() functions if you need to guarantee a specific number of sides.
	...
	{
		AddConcavePolyFilled(_Path.Data, _Path.Size, col); _Path.Size = 0;
	}
