	...
	namespace graphics
	{
		namespace dx12
		{
			...
			public:
				...
				bool CreateCommandList(Microsoft::WRL::ComPtr<ID3D12CommandAllocator> a_Allocator, D3D12_COMMAND_LIST_TYPE a_CommandListType, Microsoft::WRL::ComPtr<ID3D12Device2> a_Device);
